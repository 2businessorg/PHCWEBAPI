...
/// <summary>
/// Construtor de links HATEOAS para o módulo Advances
/// </summary>
public interface IAdvancesLinkBuilder
{
    ...
    HATEOASLink GetDetailByKeyLink(decimal ndoc, decimal rno, decimal rdano);
}
